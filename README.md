# Question & Answer Forums Importer
## Overview
Import data from the [TH] Question & Answer Forums add-on to XenForos native Q&A threads.

## Installation
1. Download the latest release from the releases tab.
2. Upload the contents of the `upload` folder within the zip file to your XenForo root directory.
3. Install the add-on either via Admin Control Panel or via the command line with `php cmd.php xf-addon:install ThemeHouse/QAForumsImporter`.

## Uninstallation
1. Uninstall the add-on either via Admin Control Panel or via the command line with `php cmd.php xf-addon:uninstall ThemeHouse/QAForumsImporter`
